...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 360 206" }, props),
        React__default['default'].createElement("image", { width: "360", height: "206", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, { alignItems: "center" },
        React__default['default'].createElement(StyledMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$N, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$M, { width: "24px", color: "textSubtle" }))),
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, { showOnNav: showOnNav },
        React__default['default'].createElement(SocialEntry, null,
            !showOnNav && (cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
                React__default['default'].createElement(Icon$v, { width: "24px", height: "24px", mr: "8px" }),
                React__default['default'].createElement(Text, { color: "contrast", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }))),
...
var Container$5 = styled__default['default'].div(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  display: none;\n  overflow-y: auto;\n  overflow-x: hidden;\n\n  ", " {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n"], ["\n  display: none;\n  overflow-y: auto;\n  overflow-x: hidden;\n\n  ", " {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#e9f1fd", background: "#010101", backgroundDisabled: "#999", contrast: "#FFFFFF", invertedContrast: "#922929", input: "#922929", inputBorder: "#cccccc", primaryDark: "#278CC7", tertiary: "#2d2f37", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#FFFFFF", borderColor: "#524B63", card: "#b53333", gradients: {
